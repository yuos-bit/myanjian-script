...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            ((TextView) findViewById(R.id.tv_version)).setText("版本 v" + ver);
        } catch (Exception ignored) {
        }

        if (!prefs.contains("morning")) {
            // 默认早8:00、晚17:00各一次
            prefs.edit().putString("morning", "08:00:00").putString("evening", "17:00:00").apply();
        }

        btnMorning = findViewById(R.id.btn_morning);
        btnEvening = findViewById(R.id.btn_evening);
        chkEnable = findViewById(R.id.chk_enable);
    ...
    private void updateUi() {
        ...
        chkEnable.setChecked(prefs.getBoolean("enabled", false));
        editingPkg = true;
